...
root=Tk()
root.title("PhoneBook By Alok Kumar")
root.geometry("1000x1000")
root.configure(background="#c6f0b9")
...
## Main Root Window
h=0
Label(root,text="Phone Book",font="Garamond 25",bg="#c6f0b9").grid(row=h,column=1,sticky="N")
photo=PhotoImage(file="PhoneBook.gif")
Label(root,image=photo).grid(row=h+1,column=1)
Label(root,text="First Name: ",font="Garamond 14",bg="#c6f0b9").grid(row=h+2,column=0,sticky="E")
fname=Entry(root,bg="#E3FFF3")
fname.grid(row=h+2,column=1)
Label(root,text="*Mandatory Field",font="Garamond 10",bg="#c6f0b9").grid(row=h+2,column=2,sticky="W")
Label(root,text="Middle Name: ",font="Garamond 14",bg="#c6f0b9").grid(row=h+3,column=0,sticky="E")
mname=Entry(root,bg="#E3FFF3")
mname.grid(row=h+3,column=1)
Label(root,text="Last Name: ",font="Garamond 14",bg="#c6f0b9").grid(row=h+4,column=0,sticky="E")
lname=Entry(root,bg="#E3FFF3")
lname.grid(row=h+4,column=1)
Label(root,text="Company Name: ",font="Garamond 14",bg="#c6f0b9").grid(row=h+5,column=0,sticky="E")
comname=Entry(root,bg="#E3FFF3")
comname.grid(row=h+5,column=1)
Label(root,text="Address: ",font="Garamond 14",bg="#c6f0b9").grid(row=h+6,column=0,sticky="E")
add=Entry(root,bg="#E3FFF3")
add.grid(row=h+6,column=1)
Label(root,text="City: ",font="Garamond 14",bg="#c6f0b9").grid(row=h+7,column=0,sticky="E")
city=Entry(root,bg="#E3FFF3")
city.grid(row=h+7,column=1)
Label(root,text="ZIP Code: ",font="Garamond 14",bg="#c6f0b9").grid(row=h+8,column=0,sticky="E")
zipcode=Entry(root,bg="#E3FFF3")
zipcode.grid(row=h+8,column=1)
Label(root,text="Website: ",font="Garamond 14",bg="#c6f0b9").grid(row=h+9,column=0,sticky="E")
web=Entry(root,bg="#E3FFF3")
web.grid(row=h+9,column=1)
Label(root,text="Date of Birth(YYYY-MM-DD): " ,font="Garamond 14",bg="#c6f0b9").grid(row=h+10,column=0,sticky="E")
...
def addph():
    ...
    i=i+2
    addem()
    Label(root,text="Select Phone Type: ",font="Garamond 14",bg="#c6f0b9").grid(row=i,column=0,sticky="E")
    offph=Radiobutton(root,text="Office",variable=ph,value="Office",tristatevalue=0,font="Garamond 14",bg="#c6f0b9")
    offph.grid(row=i,column=1)
    homph=Radiobutton(root,text="Home",variable=ph,value="Home",tristatevalue=0,font="Garamond 14",bg="#c6f0b9")
    homph.grid(row=i,column=2,sticky="W")
    mobph=Radiobutton(root,text="Mobile",variable=ph,value="Mobile",tristatevalue=0,font="Garamond 14",bg="#c6f0b9")
    mobph.grid(row=i,column=3,sticky="W")
    Label(root,text="Phone Number: ",font="Garamond 14",bg="#c6f0b9").grid(row=i+1,column=0,sticky="E")
    phno=Entry(root,bg="#E3FFF3")
    phno.grid(row=i+1,column=1)
    Label(root,text="*Mandatory Field",font="Garamond 10",bg="#c6f0b9").grid(row=i+1,column=2,sticky="W")
    Button(root,text="+",command=addph,bg="#88FFD1").grid(row=i,column=4)
def addem():
    global i,j,emid,em,offem,perem
    j=j+2
    Label(root,text="Select E-mail Type: ",font="Garamond 14",bg="#c6f0b9").grid(row=j,column=0,sticky="E")
    offem=Radiobutton(root,text="Office",variable=em,value="Office",tristatevalue=0,font="Garamond 14",bg="#c6f0b9")
    offem.grid(row=j,column=1)
    perem=Radiobutton(root,text="Personal",variable=em,value="Personal",tristatevalue=0,font="Garamond 14",bg="#c6f0b9")
    perem.grid(row=j,column=2)
    Label(root,text="E-mail ID: ",font="Garamond 14",bg="#c6f0b9").grid(row=j+1,column=0,sticky="E")
    emid=Entry(root,bg="#E3FFF3")
    emid.grid(row=j+1,column=1)
    Label(root,text="*Mandatory Field",font="Garamond 10",bg="#c6f0b9").grid(row=j+1,column=2,sticky="W")
...
def close():
    showinfo("PhoneBook","Thanks for using PhoneBook!")
    root.destroy()
addph()
